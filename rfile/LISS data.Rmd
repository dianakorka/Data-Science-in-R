...
And descriptive statistics: we have similar mean, median age and standards deviation of age across the two groups: left and right-leaning individuals.
...
We think that the error comes from typing 999 instead of 99 for the two samples above, so we make this replacement below.
