...
In our case, we need to create a treatment variable which takes value 1 when year=2022 or 2023 and the individual is left-leaning (i.e. right==0)
...
Here we obtain a negative and significant coefficient. Increasing political orientation by one unit (moving to the right) is associated with 0.287 lower propensity to vote.
